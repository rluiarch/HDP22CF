...
aws cloudformation create-stack --stack-name $1 --template-body file:///tmp/HDP-custom-k9.json --parameters file:///tmp/parameter-08.json --tags file:///tmp/tags.json  --capabilities CAPABILITY_IAM | tee stack-${1}.json
